...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2021 at 02:19 PM
...
INSERT INTO `add_category` (`cat_id`, `category_name`) VALUES
(1, 'KIDS'),
(2, 'CLOTHES');
...
INSERT INTO `tbl_product` (`product_id`, `product_name`, `product_price`, `product_category`, `ProfilePic`) VALUES
(1, 'SARI', 356, 'CLOTHES', 'sari.png'),
(2, 'BABY SHIRT', 400, 'KIDS', 'kids.png');
